<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MusicoTrabajos.aspx.vb" Inherits="contenidos_musico_MusicoTrabajos" %>
    ...
    <div id="cab">
     ...
     <asp:Panel ID="pnBuscador" runat="server">
            ...
            <asp:GridView ID="gvMusicos" runat="server" AutoGenerateColumns="False" DataKeyNames="id">
                <Columns>
                    <asp:CommandField ShowSelectButton="True" ButtonType="Button" SelectText="Unirse"/>
            ...
            <asp:Button ID="Button1" runat="server" Text="Volver a Trabajos" />
    <br />
        </section>
    </div>
    </form>
