<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Gastos.aspx.vb" Inherits="contenidos_administrador_Gastos" %>
...
<body>
   ...
   <asp:Panel ID="pnDatos" runat="server">
    ...
    <asp:DropDownList ID="ddlmusicocongasto" runat="server" DataSourceID="SqlDSmusicocongasto" DataTextField="nombre" DataValueField="idMusico">
        <asp:ListItem Value="0">Sin Musico</asp:ListItem>
       </asp:DropDownList>
    <asp:SqlDataSource ID="SqlDSmusicocongasto" runat="server" ConnectionString="<%$ ConnectionStrings:BandaDeMusicaConnectionString %>" SelectCommand="SELECT [idMusico], [nombre] FROM [Musicos]"></asp:SqlDataSource>
    <br />
