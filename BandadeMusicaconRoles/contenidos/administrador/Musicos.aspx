...
<body>
   ...
   <asp:Panel ID="pnDatos" runat="server">
    ...
    <asp:TextBox ID="tbApellidos" runat="server"></asp:TextBox>
       <br />
    <asp:RequiredFieldValidator ID="rfvApellidos" runat="server" ErrorMessage="Se requiere introducir los apellidos al músico" ControlToValidate="tbApellidos" ValidationGroup="DatosMusico" cssClass="validator"></asp:RequiredFieldValidator>
    <br />
    ...
    <asp:TextBox ID="tbUsuario" runat="server"></asp:TextBox>
       <br />
    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Se requiere introducir Usuario" ControlToValidate="tbUsuario" ValidationGroup="DatosMusico" cssClass="validator"></asp:RequiredFieldValidator>
    <br />
    <asp:Label ID="lbPass1" runat="server" Text="Contraseña: "></asp:Label>
    <asp:TextBox ID="tbPass1" runat="server"></asp:TextBox>
       <br />
    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Se requiere introducir la contraseña" ControlToValidate="tbPass1" ValidationGroup="DatosMusico" cssClass="validator"></asp:RequiredFieldValidator>
    <asp:RegularExpressionValidator ID="REpassw" runat="server" Display="Dynamic" ControlToValidate="tbPass1" ErrorMessage="Contraseña entre 5 y 15 caracteres" ValidationExpression="\w{5,15}" ValidationGroup="DatosMusico" cssClass="validator" />
       <br />
    <asp:Label ID="lbPass2" runat="server" Text="Repite Contraseña: "></asp:Label>
    <asp:TextBox ID="tbPass2" runat="server"></asp:TextBox>
       <br />
    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Se requiere introducir la confirmación de la contraseña" ControlToValidate="tbPass2" ValidationGroup="DatosMusico" cssClass="validator"></asp:RequiredFieldValidator>
       <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" Display="Dynamic" ControlToValidate="tbPass2" ErrorMessage="Contraseña entre 5 y 15 caracteres" ValidationExpression="\w{5,15}" ValidationGroup="DatosMusico" cssClass="validator" />
       <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="Las contraseñas no coinciden" ControlToCompare="tbPass1" ControlToValidate="tbPass2" ValidationGroup="DatosMusico" cssClass="validator"></asp:CompareValidator>
    <br />
